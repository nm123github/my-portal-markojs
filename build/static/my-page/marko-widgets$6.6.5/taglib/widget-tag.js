$_mod.def("/marko-widgets$6.6.5/taglib/widget-tag", function(require, exports, module, __filename, __dirname) { /*
...
'use strict';
var markoWidgets = require('/marko-widgets$6.6.5/lib/index-browser'/*'../'*/);
var extend = require('/raptor-util$2.0.1/extend'/*'raptor-util/extend'*/);
var widgetArgsId = require('/marko-widgets$6.6.5/lib/widget-args-id'/*'../lib/widget-args-id'*/);
var widgetBodyHelper = require('/marko-widgets$6.6.5/taglib/helpers/widgetBody'/*'./helpers/widgetBody'*/);
