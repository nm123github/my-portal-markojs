$_mod.def("/marko-widgets$6.6.5/lib/defineRenderer", function(require, exports, module, __filename, __dirname) { /*
...
module.exports = function defineRenderer(def) {
    ...
    renderer.render = function(data, callback) {
        if(!callback) {
            require('/marko-widgets$6.6.5/lib/deprecate'/*'./deprecate'*/).warn(
