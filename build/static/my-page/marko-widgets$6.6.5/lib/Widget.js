$_mod.def("/marko-widgets$6.6.5/lib/Widget", function(require, exports, module, __filename, __dirname) { /*
        ...
        if (args.length === 1) {
            ...
            if (typeof arg === 'function') {
                ...
                if (typeof console !== 'undefined') console.log(
                    'this.$ is deprecated and Marko 4 will not have jQuery bindings.\n'+
            ...
            if (typeof console !== 'undefined') console.log(
                'this.$ is deprecated and Marko 4 will not have jQuery bindings.\n'+
                'OLD: this.$();\n'+
                'NEW: var $ = require("jquery"); $(this.el);'
            );
