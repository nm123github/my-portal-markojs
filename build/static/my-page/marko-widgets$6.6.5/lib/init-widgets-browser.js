$_mod.def("/marko-widgets$6.6.5/lib/init-widgets-browser", function(require, exports, module, __filename, __dirname) { /*
...
var logger = require('/raptor-logging$1.1.3/lib/index'/*'raptor-logging'*/).logger(module);
...
var _addEventListener = require('/marko-widgets$6.6.5/lib/addEventListener'/*'./addEventListener'*/);
var registry = require('/marko-widgets$6.6.5/lib/registry'/*'./registry'*/);
var warp10Finalize = require('/warp10$1.3.5/finalize'/*'warp10/finalize'*/);
var eventDelegation = require('/marko-widgets$6.6.5/lib/event-delegation'/*'./event-delegation'*/);
